...
plt.tight_layout()
plt.savefig("../plots/apri-nor-sep-dist_bgt.eps")
plt.close()
...
plt.tight_layout()
plt.savefig("../plots/post-nor-sep-dist_bgt.eps")
plt.close()
...
# ICRF1
weights = np.ones_like(apri_x_icrf1) * 100. / apri_x_icrf1.size
ax0.hist(apri_x_icrf1, bins_array, weights=weights, color="b", histtype="step", label="pre-fit")
ax0.hist(post_x_icrf1, bins_array, weights=weights, color="r", histtype="step", label="post-fit")
ax0.plot(bins_array, rayleigh_dist, "g--", linewidth=1)
...
# ICRF2
weights = np.ones_like(apri_x_icrf2) * 100. / apri_x_icrf2.size
ax1.hist(apri_x_icrf2, bins_array, weights=weights, color="b", histtype="step", label="pre-fit")
ax1.hist(post_x_icrf2, bins_array, weights=weights, color="r", histtype="step", label="post-fit")
ax1.plot(bins_array, rayleigh_dist, "g--", linewidth=1)
...
ax2.hist(apri_x_icrf3sx, bins_array, weights=weights,
         color="b", histtype="step", label="pre-fit")
ax2.hist(post_x_icrf3sx, bins_array, weights=weights, color="r", histtype="step", label="post-fit")
ax2.plot(bins_array, rayleigh_dist, "g--", linewidth=1)
...
# ICRF3 K
weights = np.ones_like(apri_x_icrf3k) * 100. / apri_x_icrf3k.size
ax3.hist(apri_x_icrf3k, bins_array, weights=weights, color="b", histtype="step", label="pre-fit")
ax3.hist(post_x_icrf3k, bins_array, weights=weights, color="r", histtype="step", label="post-fit")
ax3.plot(bins_array, rayleigh_dist, "g--", linewidth=1)
...
# ICRF3 X/Ka
weights = np.ones_like(apri_x_icrf3xka) * 100. / apri_x_icrf3xka.size
ax4.hist(apri_x_icrf3xka, bins_array, weights=weights, color="b", histtype="step", label="pre-fit")
ax4.hist(post_x_icrf3xka, bins_array, weights=weights, color="r", histtype="step", label="post-fit")
ax4.plot(bins_array, rayleigh_dist, "g--", linewidth=1)
...
plt.tight_layout()
# plt.savefig("../plots/nor-sep-dist_bgt.eps")
