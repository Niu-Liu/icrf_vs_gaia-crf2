...
plt.tight_layout()
# plt.savefig("../plots/rotation.eps")
# plt.savefig("../plots/rotation_bgt.eps")
plt.savefig("../plots/fig06.eps")
plt.close()
...
# plt.savefig("../plots/glide_bgt.eps")
...
# plt.savefig("../plots/quadrupole_bgt.eps")
