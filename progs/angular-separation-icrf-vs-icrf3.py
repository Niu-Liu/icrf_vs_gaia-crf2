...
apri_sep_icrf2 = calc_apri_sep(icrf2_gdr2)
apri_sep_icrf3sx = calc_apri_sep(icrf3sx_gdr2)
...
com_sou_2v3sx = join(apri_sep_icrf2, apri_sep_icrf3sx,
...
# Angular separation
ax0.plot(com_sou_2v3sx["ang_sep_2"], com_sou_2v3sx["ang_sep_3sx"], "x", ms=1)
# Plot y=x
...
ax1.plot(com_sou_2v3sx["nor_sep_2"], com_sou_2v3sx["nor_sep_3sx"], "x", ms=1)
# Plot y=x
...
plt.tight_layout()
plt.savefig("../plots/apri_sep_icrf2_vs_icrf3.eps")
plt.close()
...
plt.tight_layout()
# plt.savefig("../plots/post_sep_icrf2_vs_icrf3.eps")
plt.savefig("../plots/fig14.eps")
plt.close()
# --------------------------------- END --------------------------------
